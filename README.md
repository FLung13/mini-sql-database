...
This separation reflects real database architecture (e.g., PostgreSQL, MySQL) at a simplified level.
...
CMake
Build and Run
git clone https://github.com/YOUR_USERNAME/mini-sql-database.git
